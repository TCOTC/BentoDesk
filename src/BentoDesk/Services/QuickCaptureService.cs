...
public sealed class QuickCaptureService
{
    ...
    public void MarkClipboardTextWrittenByBentoDesk(string? body)
    {
        BentoDeskClipboardWriteScope.MarkText(NormalizeBody(body));
    }
    ...
    {
        return BentoDeskClipboardWriteScope.ShouldIgnoreText(body);
    }
