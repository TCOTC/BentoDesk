...
public static class AppRelaunchService
{
    ...
    {
        string appPath = Environment.ProcessPath ?? Path.Combine(AppContext.BaseDirectory, "BentoDesk.exe");
        if (!File.Exists(appPath))
        {
            return AppRelaunchScheduleResult.Failed("BentoDesk.exe was not found.");
        }
        ...
        try
        {
            ...
            {
                return AppRelaunchScheduleResult.Failed("BentoDesk.Updater.exe was not found.");
            }
