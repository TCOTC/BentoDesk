...
public sealed partial class QuickCaptureWidgetViewModel
{
    ...
    public async Task CopyItemAsync(QuickCaptureItemViewModel item)
    {
        ...
        {
            _quickCaptureService.MarkClipboardTextWrittenByBentoDesk(formattedText);
        }
    }
        ...
        string? recordText)
    {
        ...
        if (!string.IsNullOrWhiteSpace(recordText))
        {
            ...
            BentoDeskClipboardWriteScope.MarkWrite(text: recordText);
        }
            ...
            File.Exists(item.ImagePath))
        {
            ...
            BentoDeskClipboardWriteScope.MarkWrite(
                hasImage: true,
        ...
        else
        {
            ...
            BentoDeskClipboardWriteScope.MarkWrite(text: text);
        }
