...
{
    private const string LogoIconFileName = "bentodesk.ico";
    private const string LogoSvgUriString = "ms-appx:///Assets/bentodesk.svg";
    private const string TrayIconLightFileName = "bentodesk-tray-light.ico";
    private const string TrayIconDarkFileName = "bentodesk-tray-dark.ico";
    ...
    public static Icon? CreateTrayIcon(string style, bool isDarkTheme)
    {
        ...
        {
            global::BentoDesk.App.Log($"[Branding] Failed to load tray icon: {ex.Message}");
            return null;
        }
    }
    ...
    public static void ApplyWindowIcon(AppWindow? appWindow)
    {
        ...
        {
            global::BentoDesk.App.Log($"[Branding] Failed to apply window icon: {ex.Message}");
        }
    }
}
