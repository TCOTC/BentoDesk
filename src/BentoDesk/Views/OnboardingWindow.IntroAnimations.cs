...
public sealed partial class OnboardingWindow
{
    ...
    private async void PlayIntroSequence()
    {
        ...
        var mark = CreateBentoDeskMark(size: 170, layerWidth: 108, layerHeight: 102, cornerRadius: 18, offsetX: 25, offsetY: 20);
    ...
    // ════════════════════════════════════════════════════════════
    //  BentoDesk Mark (logo layers)
    // ════════════════════════════════════════════════════════════

    private Canvas CreateBentoDeskMark(
        double size = 130,
        ...
        double offsetY = 14)
    {
        ...
        canvas.Children.Add(CreateBentoDeskMarkLayer(0, layerWidth, layerHeight, cornerRadius, offsetX, offsetY));
        canvas.Children.Add(CreateBentoDeskMarkLayer(1, layerWidth, layerHeight, cornerRadius, offsetX, offsetY));
        canvas.Children.Add(CreateBentoDeskMarkLayer(2, layerWidth, layerHeight, cornerRadius, offsetX, offsetY));
        return canvas;
    }

    private Border CreateBentoDeskMarkLayer(
        int index,
        double layerWidth,
        double layerHeight,
        double cornerRadius,
