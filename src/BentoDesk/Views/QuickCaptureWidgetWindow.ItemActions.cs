...
public sealed partial class QuickCaptureWidgetWindow
{
    ...
    {
        if (_isInternalQuickCaptureDrag || !BentoDeskDragData.HasDroppedFiles(e.DataView))
        {
            return;
        }
    ...
    private bool TryPrepareQuickCaptureDragPackage(DataPackage dataPackage, QuickCaptureItemViewModel item)
    {
        ...
        if (selectedItems.Count > 1 && item.IsCopySelected)
        {
            ...
            BentoDeskDragData.SetText(dataPackage, text, BentoDeskDragData.SourceQuickCapture);
            ...
            File.Exists(item.ImagePath))
        {
            ...
            {
                BentoDeskDragData.SetText(dataPackage, item.Body, BentoDeskDragData.SourceQuickCapture);
            }
