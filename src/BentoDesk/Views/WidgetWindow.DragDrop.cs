...
public sealed partial class WidgetWindow
{
    ...
    private const string BentoDeskInternalDragToken = "BentoDesk.WidgetItemDrag.v2";
...
StopDragHighlight();
        ...
        try
        {
            ...
            string? syncSourceWidgetId = TryGetPackageString(e.DataView.Properties, "BentoDeskSourceWidgetId");
            var syncSourcePaths = TryGetPackageStringArray(e.DataView.Properties, "BentoDeskSourcePaths");
        ...
        Windows.Foundation.Point position)
    {
        ...
        var dragPaths = TryGetPackageStringArray(properties, "BentoDeskSourcePaths");
