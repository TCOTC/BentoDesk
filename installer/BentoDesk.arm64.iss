; BentoDesk ARM64 安装脚本
; 构建命令：
; dotnet publish ..\src\BentoDesk\BentoDesk.csproj --configuration Release -p:Platform=ARM64 -p:RuntimeIdentifier=win-arm64 -p:SelfContained=false -p:WindowsAppSDKSelfContained=false -o ..\artifacts\publish\BentoDesk\arm64 -v:minimal
...
#define MyAppReleaseDir "..\artifacts\publish\BentoDesk\arm64"
#endif
