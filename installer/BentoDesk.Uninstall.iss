...
const
  ...
  BentoDeskDataSettingsPath = '{localappdata}\BentoDesk\data\settings.json';
  BentoDeskDefaultManagedStorageRootPath = '{%USERPROFILE}\BentoDesk';
...
begin
  Result := ExpandConstant(BentoDeskDefaultManagedStorageRootPath);
  SettingsPath := ExpandConstant(BentoDeskDataSettingsPath);
